...
if DEF(FAITHFUL)
	...
	move STRENGTH,        EFFECT_DEF_DOWN_HIT,       80, NORMAL,    100, 15,   0, PHYSICAL
endc
...
endc
	...
	move HEALINGLIGHT,    EFFECT_HEALING_LIGHT,       0, NORMAL,     -1, 20,   0, STATUS
...
if DEF(FAITHFUL)
	...
	move BRICK_BREAK,     EFFECT_BRICK_BREAK,        80, FIGHTING,  100, 15,   0, PHYSICAL
endc
if DEF(FAITHFUL)
